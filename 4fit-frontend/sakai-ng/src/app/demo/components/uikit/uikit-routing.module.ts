...
@NgModule({
    imports: [RouterModule.forChild([
        ...
        { path: 'charts', data: { breadcrumb: 'Charts' }, loadChildren: () => import('./charts.balançofinanceiro/chartsdemo.module').then(m => m.ChartsDemoModule) },
        ...
        { path: 'formlayout', data: { breadcrumb: 'Form Layout' }, loadChildren: () => import('./gastosprincipais/formlayoutdemo.module').then(m => m.FormLayoutDemoModule) },
        { path: 'input', data: { breadcrumb: 'Input' }, loadChildren: () => import('./input.cadastroinstrutor/inputdemo.module').then(m => m.InputDemoModule) },
        ...
        { path: 'panel', data: { breadcrumb: 'Panel' }, loadChildren: () => import('./panel.home/panelsdemo.module').then(m => m.PanelsDemoModule) },
        { path: 'table', data: { breadcrumb: 'Table' }, loadChildren: () => import('./table.cadastroaluno/tabledemo.module').then(m => m.TableDemoModule) },
